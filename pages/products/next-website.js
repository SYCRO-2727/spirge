    ...
    return (
        ...
        <div className={styles.div_info}>
            <div className={styles.details}>
                ...
                <p className={styles.p}><Link className={styles.link} href="/main/contact">Contact us</Link> by email with a wireframe drawing of how you&apos;d like us to design your site, or a reference website. We&apos;ll email or call you back shortly with a consult price! From there we can work out the information you&apos;d like to fill your site with. We&apos;ll also give you a time estimate for completion.</p>
            </div>
